...
const STAGE_FOODS = {
  gokkon: {
    ...
    '野菜':           ['にんじん','かぼちゃ','大根','ほうれん草','キャベツ','コーン（裏ごし）'],
    '果物':           ['バナナ','りんご','みかん'],
    '魚介':           ['白身魚','しらす（塩抜き）'],
    '大豆・卵・乳製品':['豆腐（絹）'],
  },
  ...
  kamikami: {
    ...
    '魚介':           ['しじみ','あさり'],
    '肉類':           ['鶏むね肉','鶏もも肉','豚ひれ肉'],
    '大豆・卵・乳製品':['全卵','カッテージチーズ','高野豆腐','油揚げ','そら豆'],
  },
  pakupaku: {
    '穀物・炭水化物': ['ロールパン','白米（軟らかめ）','食パン'],
    '野菜':           ['ごぼう','きのこ類','トマト','ピーマン'],
    '魚介':           ['えび','さば','いわし'],
    '肉類':           ['牛ひれ肉','豚挽き肉','牛挽き肉'],
    '大豆・卵・乳製品':['クリームチーズ','牛乳'],
...
const FOOD_WARNINGS = [
  ...
  },
  {
    ...
    color: '#D97706',
    bg: '#FFFBEB',
    detail: '必ず固ゆでにしてから与えてください。卵黄は7〜8ヶ月から、全卵は9〜11ヶ月からが目安です。（厚労省ガイド）'
  },
  {
    keywords: ['パン', 'うどん', '小麦'],
    badge: '⚠️ 小麦アレルギー注意',
